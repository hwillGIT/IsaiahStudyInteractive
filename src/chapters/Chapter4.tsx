/**
 * Chapter 4: The Branch of the LORD and God's Return
 * 
...
import { Chapter4StructureModal } from '../components/Chapter4StructureModal';
...
// Chapter 4 uses standard yellow for all hinges
...
function Chapter4() {
  ...
  const { data, loading, error } = useChapterData(4);

  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-xl text-gray-600">Loading Chapter 4...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2 text-white">Isaiah Chapter 4</h1>
          <p className="text-xl text-gray-200">The Branch of the LORD and God's Return</p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-8">
          {verses.map((verse) => (
            ...
            >
              <div className="text-sm font-bold">4:{verse.number}</div>
              {verse.isHinge && (
              ...
              <div className="hidden group-hover:block absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 bg-gray-900 text-white text-xs rounded py-2 px-3 z-10">
                <div className="font-bold mb-1">Verse 4:{verse.number}</div>
            ...
            <div className="bg-white rounded-lg max-w-2xl w-full my-8">
              <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-t-lg">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-2xl font-bold">Isaiah 4:{selectedVerse}</h3>
                  <button
                  ...
                  <div className="space-y-4">
                    ...
                    {getConnection(selectedVerse)?.to && getConnection(selectedVerse)!.to!.length > 0 && (
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2 flex items-center gap-2">
                          <span className="text-blue-600">→</span>
                          <span>This Points Forward To:</span>
                        </h4>
                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    {getConnection(selectedVerse)?.context && (
                      <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-l-4 border-purple-600 p-4 rounded">
