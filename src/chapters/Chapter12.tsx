      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 bg-white rounded-lg shadow-sm px-4 py-2 text-sm flex-wrap">
            ...
            <Link to="/chapter-10" className="text-blue-600 hover:text-blue-800 font-medium px-2 py-1 hover:bg-blue-50 rounded">Ch 10</Link>
            <Link to="/chapter-11" className="text-blue-600 hover:text-blue-800 font-medium px-2 py-1 hover:bg-blue-50 rounded">Ch 11</Link>
            <span className="text-gray-800 font-semibold px-2 py-1 bg-blue-100 rounded">Ch 12</span>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">The Concluding Hymn</h3>
                  <p className="text-gray-700 leading-relaxed">
                    Chapter 12 serves as the lyrical epilogue to Isaiah 1-12, the "Book of Immanuel." This thanksgiving song celebrates God's salvation in two movements: personal testimony (vv1-3) flowing into corporate proclamation (vv4-6). The structure moves from individual gratitude to global mission—from "I will give thanks" to "make known His deeds among the peoples." The chapter echoes Exodus 15 (Moses' song after the Red Sea), framing Isaiah's prophecies as a second exodus where God's anger turns to comfort and the Holy One dwells joyfully in Zion's midst.
                  </p>
                </div>
