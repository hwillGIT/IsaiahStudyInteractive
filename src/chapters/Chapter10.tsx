      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 bg-white rounded-lg shadow-sm px-4 py-2 text-sm flex-wrap">
            ...
            <span className="text-gray-800 font-semibold px-2 py-1 bg-blue-100 rounded">Ch 10</span>
            <Link to="/chapter-11" className="text-blue-600 hover:text-blue-800 font-medium px-2 py-1 hover:bg-blue-50 rounded">Ch 11</Link>
            <Link to="/chapter-12" className="text-blue-600 hover:text-blue-800 font-medium px-2 py-1 hover:bg-blue-50 rounded">Ch 12</Link>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Sovereignty Over Nations</h3>
                  <p className="text-gray-700 leading-relaxed">
                    Chapter 10 reveals God's sovereignty over world empires. Assyria serves as His "rod of anger" to discipline Israel, yet remains accountable for its arrogant intentions. The chiastic center (v12) holds the key: God will complete His work on Zion, THEN judge Assyria's pride. This demonstrates that even pagan superpowers unknowingly fulfill divine purposes while remaining responsible for their evil motives.
                  </p>
                </div>
