    ...
    <div className="min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2 text-gray-800">Isaiah Chapter 2</h1>
          <p className="text-xl text-gray-600">God's Mountain, Idolatry, and the Day of the LORD</p>
        </div>
